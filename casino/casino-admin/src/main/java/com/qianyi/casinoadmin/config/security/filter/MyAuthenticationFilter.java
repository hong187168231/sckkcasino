package com.qianyi.casinoadmin.config.security.filter;

import com.qianyi.casinoadmin.config.security.util.Constants;
import com.qianyi.casinoadmin.config.security.util.MultiReadHttpServletRequest;
import com.qianyi.casinoadmin.config.security.util.MultiReadHttpServletResponse;
...
public class MyAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected MyAuthenticationFilter(SysUserService sysUserService) {
