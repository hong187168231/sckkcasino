...
public class CompanyProxyDetailController {
    ...
    public ResponseEntity<CompanyProxyReportVo> find(Integer pageSize, Integer pageCode, Integer proxyRole, Integer tag,
        String userName, @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date startDate, Long companyId,
    ...
    private ResponseEntity<CompanyProxyReportVo> getComparatorResult(ProxyUser proxyUser, Integer content, Integer sort,
        ...
        try {
            ...
            PageResultVO<CompanyProxyReportVo> pageResultVO =
                (PageResultVO<CompanyProxyReportVo>)CommonUtil.handlePageResult(list, pageVO);
            ...
            content1.forEach(companyProxyReportVo -> {
                ...
                vo.setGroupNewProxyUsers(
                    proxyHomePageReport.getNewSecondProxys() + proxyHomePageReport.getNewThirdProxys());
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "当前id", required = false),
        @ApiImplicitParam(name = "userName", value = "账号", required = false),
        @ApiImplicitParam(name = "startDate", value = "起始时间查询", required = true),
        @ApiImplicitParam(name = "endDate", value = "结束时间查询", required = true),})
    public ResponseEntity<CompanyProxyReportVo> findDailyDetails(Long id, String userName,
        ...
        // List<ProxyHomePageReport> proxyHomePageReports =
        // proxyHomePageReportService.findHomePageReports(proxyHomeReport,startTime,endTime,sort);
    ...
    private CompanyProxyReportVo assembleData(ProxyUser byId, Date startDate, Date endDate, String startTime,
        String endTime) {
        ProxyHomePageReport proxyHomePageReport = new ProxyHomePageReport();
        ...
        companyProxyReportVo
            .setGroupNewProxyUsers(proxyHomePageReport.getNewSecondProxys() + proxyHomePageReport.getNewThirdProxys());
    ...
    // companyProxyReportVo.setGroupPerformance(proxyHomePageReport.getValidbetAmount());
    // companyProxyReportVo.setGroupNewUsers(proxyHomePageReport.getNewUsers());
    // companyProxyReportVo.setGroupNewProxyUsers(proxyHomePageReport.getNewSecondProxys() +
    // proxyHomePageReport.getNewThirdProxys());
