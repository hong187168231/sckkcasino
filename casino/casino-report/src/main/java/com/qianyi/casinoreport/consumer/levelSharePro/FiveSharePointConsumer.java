...
@Slf4j
@RabbitListener(queues = RabbitMqConstants.FIVE_SHAREPROFIT_DIRECTQUEUE)
@Component
public class FiveSharePointConsumer {
    ...
    public void process(ShareProfitBO shareProfitBO, Channel channel, Message message) throws IOException {
        log.info("FIVE-start 游戏id:{},代理线分润消息队列：{}",shareProfitBO.getRecordId(),shareProfitBO);
        try {
        ...
        log.info("FIVE-end 游戏id:{},代理线分润消息队列：{}",shareProfitBO.getRecordId(),shareProfitBO);
    }
}
