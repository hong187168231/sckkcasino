...
@Slf4j
@RabbitListener(queues = RabbitMqConstants.NINE_SHAREPROFIT_DIRECTQUEUE)
@Component
public class NineSharePointConsumer {
    ...
    public void process(ShareProfitBO shareProfitBO, Channel channel, Message message) throws IOException {
        log.info("NINE-start 游戏id:{},代理线分润消息队列：{}",shareProfitBO.getRecordId(),shareProfitBO);
        try {
        ...
        log.info("NINE-end 游戏id:{},代理线分润消息队列：{}",shareProfitBO.getRecordId(),shareProfitBO);
    }
}
