...
@Slf4j
@RabbitListener(queues = RabbitMqConstants.FOUR_SHAREPROFIT_DIRECTQUEUE)
@Component
public class FourSharePointConsumer {
    ...
    public void process(ShareProfitBO shareProfitBO, Channel channel, Message message) throws IOException {
        log.info("FOUR-start 游戏id:{},代理线分润消息队列：{}",shareProfitBO.getRecordId(),shareProfitBO);
        try {
        ...
        log.info("FOUR-end 游戏id:{},代理线分润消息队列：{}",shareProfitBO.getRecordId(),shareProfitBO);
    }
}
