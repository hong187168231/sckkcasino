...
//    @NoAuthorization
    ...
    public ResponseEntity<PersonReportVo> queryPersonReport(
        ...
        if(StringUtils.hasLength(userName)){
            ...
            if(user != null){
                List<RebateReportVo> reportResult = userService.findRebateMap(platform,startTimeStr,endTimeStr,user.getId(),orderTimeStart,orderTimeEnd,proxy);
        ...
        try {
            ...
            reportResult = userService.findRebateMap(platform, startTimeStr, endTimeStr, page, pageSize, statement,orderTimeStart,orderTimeEnd,proxy);
        } catch (Exception e) {
    ...
    public ResponseEntity<RebateReportTotalVo> queryTotal(
        ...
        if(StringUtils.hasLength(userName)){
            ...
            if(user != null){
                ...
                userId=user.getId();
                List<RebateReportVo> maps = userService.findRebateMap(platform, startTime, endTime, userId,orderTimeStart,orderTimeEnd,proxy);
            ...
            Map<String,Object> result = userService.findRebateMap(platform,startTime,endTime,orderTimeStart,orderTimeEnd,proxy);
