...
public interface GameRecordReportNewRepository  extends JpaRepository<GameRecordReportNew,Long>, JpaSpecificationExecutor<GameRecordReportNew> {
    ...
    @Modifying
    @Query(value = "INSERT INTO game_record_report01 (game_record_report_id,statics_times,bet_amount,valid_amount,"
        + "win_loss_amount,amount,betting_number,first_proxy,second_proxy,third_proxy,gid) " +
