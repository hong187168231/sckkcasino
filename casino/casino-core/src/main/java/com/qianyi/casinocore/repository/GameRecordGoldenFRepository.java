...
public interface GameRecordGoldenFRepository extends JpaRepository<GameRecordGoldenF,Long>, JpaSpecificationExecutor<GameRecordGoldenF> {
    ...
    @Modifying(clearAutomatically = true)
    @Query("update GameRecordGoldenF u set u.levelWaterStatus=?2 where u.id=?1")
    ...
    List<GameRecordGoldenF> findByBetIdAndTransTypeAndVendorCode(String betId, String transType,String vendorCode);
