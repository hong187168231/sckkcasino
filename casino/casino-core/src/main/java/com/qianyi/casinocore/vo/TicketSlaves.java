...
public class TicketSlaves {
    ...
    private Integer child_ticket_no;    //子单号
    ...
    private String bet_amount;      //下注金额
    private String bet_net_amount;  //bet_net_amount
    ...
    private Integer game_type;  //下注模式 - 3D，4D
    ...
    private Integer progress_status;    //注单进展- IN_PROGRESS (进行中)，ACCEPTED (已接受)，PARTIALLY_ACCEPTED (部分接受)，REJECTED (拒绝)，DELETED (删除
