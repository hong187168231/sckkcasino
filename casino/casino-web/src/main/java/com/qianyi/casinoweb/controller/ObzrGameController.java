...
//    @ApiOperation("重置obzr登录密码")
//    @GetMapping("/resetLoginPwd")
//    @NoAuthentication
//    @ApiImplicitParams({@ApiImplicitParam(name = "obzrAccount", value = "obzrAccount", required = true)})
//    public ResponseEntity<Boolean> getBalance(@RequestParam("obzrAccount") String obzrAccount) {
//        boolean register = obApi.resetLoginPwd(obApi.getMerchantCode()+"_"+obzrAccount);
