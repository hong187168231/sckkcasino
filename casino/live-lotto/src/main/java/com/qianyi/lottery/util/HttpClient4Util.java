...
//            httpGet.setHeader("Authorization", "Bearer da3efcbf-0845-4fe3-8aba-ee040be542c0");
    ...
    public static String doPostJson(String url, String json, String token) {
        log.info("doPostJson请求路径{}", url);
        log.info("doPostJson请求参数json={},token={}", json, token);
        CloseableHttpClient httpClient = null;
...
//        stringEntity.setContentEncoding("UTF-8");
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                log.info("doPost请求返回参数{},请求URLDMC{}", result,url);
            } else {
                log.error("请求成功，但是返回错误码,response:{}", httpResponse);
