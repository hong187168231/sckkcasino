...
public class RabbitMqConstants {
    ...
    public final static String ONE_REPORTDAY_PROFIT_QUEUE = "one.report.day.profit.queue";
    public final static String ONE_REPORTDAY_PROFIT_DIRECT = "oneReportDayShareProfit";

    public final static String TWO_REPORTDAY_PROFIT_QUEUE = "two.report.day.profit.queue";
    public final static String TWO_REPORTDAY_PROFIT_DIRECT = "twoReportDayShareProfit";

    public final static String THREE_REPORTDAY_PROFIT_QUEUE = "three.report.day.profit.queue";
    public final static String THREE_REPORTDAY_PROFIT_DIRECT = "threeReportDayShareProfit";

    public final static String FOUR_REPORTDAY_PROFIT_QUEUE = "four.report.day.profit.queue";
    public final static String FOUR_REPORTDAY_PROFIT_DIRECT = "fourReportDayShareProfit";


    public final static String FIVE_REPORTDAY_PROFIT_QUEUE = "five.report.day.profit.queue";
    public final static String FIVE_REPORTDAY_PROFIT_DIRECT = "fiveReportDayShareProfit";


    public final static String SIX_REPORTDAY_PROFIT_QUEUE = "six.report.day.profit.queue";
    public final static String SIX_REPORTDAY_PROFIT_DIRECT = "sixReportDayShareProfit";
    ...
    public final static String ONE_REPORT_PROFIT_QUEUE = "one.report.profit.queue";
    public final static String ONE_REPORT_PROFIT_DIRECT = "oneReportShareProfit";


    public final static String TWO_REPORT_PROFIT_QUEUE = "two.report.profit.queue";
    public final static String TWO_REPORT_PROFIT_DIRECT = "twoReportShareProfit";

    public final static String THREE_REPORT_PROFIT_QUEUE = "three.report.profit.queue";
    public final static String THREE_REPORT_PROFIT_DIRECT = "threeReportShareProfit";

    public final static String FOUR_REPORT_PROFIT_QUEUE = "four.report.profit.queue";
    public final static String FOUR_REPORT_PROFIT_DIRECT = "fourReportShareProfit";


    public final static String FIVE_REPORT_PROFIT_QUEUE = "five.report.profit.queue";
    public final static String FIVE_REPORT_PROFIT_DIRECT = "fiveReportShareProfit";

    public final static String SIX_REPORT_PROFIT_QUEUE = "six.report.profit.queue";
    public final static String SIX_REPORT_PROFIT_DIRECT = "sixReportShareProfit";
