...
////        timeToEndTime             -- 指定日期结束时间
////                getStartTime      -- 指定日期开始时间
//        String str = "2019-11-01";
//        Date endStr = timeToEndTime(dateTime("yyyy-MM-dd",str));
//        Date startStr = getStartTime(dateTime("yyyy-MM-dd",str));
...
//    }
    ...
    public static SimpleDateFormat getSimpleDateFormat(String patten) {
     ...
     public static SimpleDateFormat getSimpleDateFormat() {
         return getSimpleDateFormat(YYYY_MM_DD_HH_MM_SS);
     }
}
